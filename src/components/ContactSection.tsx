export default function ContactSection() {
    return (
        <section id="contact" className="py-16 sm:py-20 bg-[var(--color-bg-primary)]">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
                <div className="text-center">
                    <h2 className="text-fluid-3xl font-bold text-[var(--color-text-primary)] mb-3 sm:mb-4">
                        Contact
                    </h2>
                    <p className="text-fluid-base text-[var(--color-text-secondary)] mb-8 sm:mb-10">
                    ...
                    <div className="flex justify-center gap-4 sm:gap-6">
                        ...
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/maadhu-avati-525435279"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full bg-[var(--color-bg-secondary)] border border-[var(--color-border-subtle)] hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)] active:scale-95 text-[var(--color-text-secondary)] hover:text-white transition-all touch-target"
                            aria-label="LinkedIn"
